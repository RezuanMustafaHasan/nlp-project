...
\vspace{4mm}
{\LARGE\bfseries A Lightweight Bangla Review Analytics\par}
\vspace{1.5mm}
...
\vspace{3mm}
{\large\bfseries Saleheen Uddin Sakin, 2107103\par}
\vspace{1.5mm}
{\large\bfseries Sree Shuvo Kumar Joy, 2107116\par}
\vspace{3mm}
{\large\bfseries Year: 4th \qquad Term: 2nd\par}
...
\vfill
{\large\textbf{Date of Submission:} September 20, 2026\par}
\vspace{8mm}
\end{center}
\end{titlepage}
...
\begin{table}[h]
\centering
\caption{Overall results. Values are percentages except the final rate.}
\small
\begin{tabular}{@{}llrrrrr@{}}
\toprule
\textbf{Split} & \textbf{Model} & \textbf{Macro-F1} & \textbf{Micro-F1} & \textbf{Exact} & \textbf{Span-F1} & \textbf{False paren/1k} \\
\midrule
Validation & BanglaBERT & \textbf{68.58} & \textbf{93.05} & \textbf{83.74} & \textbf{73.30} & \textbf{1.964} \\
Validation & BiLSTM & 50.32 & 89.61 & 77.81 & 40.34 & 9.495 \\
\addlinespace
Retained benchmark & BanglaBERT & \textbf{68.93} & \textbf{92.96} & \textbf{83.46} & \textbf{74.89} & \textbf{1.687} \\
Retained benchmark & BiLSTM & 52.05 & 89.77 & 77.93 & 43.01 & 9.088 \\
\bottomrule
\end{tabular}
\end{table}
